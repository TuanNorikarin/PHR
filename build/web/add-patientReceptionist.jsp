                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id='inputPhone' class="form-control" name="phone" type="text">
                                                                                    ...
                                                                                    complete: function (jqXHR) {
                                                                                        ...
                                                                                        if (jqXHR.status === 201) {
                                                                                            $.ajax({
                                                                                                ...
                                                                                                headers: {
                                                                                                    Authorization: 'Bearer ' + token},
                                                                                                url: "https://bt-application.herokuapp.com/api/userinfor/" + idUser,
                                                                                                success: function (data) {
                                                                                                    localStorage.setItem("dataPat", JSON.stringify(data));
