...
public final class test_002ddetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <div class=\"col-sm-3 col-3\"></div>\r\n");
      out.write("                 <div class=\"col-sm-6 col-3\">\r\n");
      out.write("                     <label><h4>Choose Children value</h4></label>\r\n");
      out.write("                     <select>\r\n");
      out.write("                         <option value=\"children\">Children</option>\r\n");
      out.write("                         <option value=\"adult\">Adult</option>\r\n");
      out.write("                     </select>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"col-sm-3 col-3\">\r\n");
      out.write("                    <div>\r\n");
      out.write("                        <buttom id=\"buttonAdd\" class=\"btn btn btn-primary\"><i class=\"fa fa-plus\"></i> Add Text Indexes to Package</buttom>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"row\">\r\n");
      out.write("                <div class=\"col-md-12\">\r\n");
      out.write("                    <h3 id=\"packageName\" class=\"blog-title\"></h3>\r\n");
      out.write("                    <span id='messageName'></span>\r\n");
      out.write("                    <div id=\"hiddenWall\" class=\"col-8 testPackage\">                        \r\n");
      ...
      out.write("//                console.log(typeof(testId));\r\n");
      out.write("                if(testId === 0){\r\n");
      out.write("                $('#hiddenWall').addClass('error');\r\n");
      out.write("                 document.getElementById(\"hiddenWall\").style.display = \"none\";\r\n");
      out.write("                 document.getElementById('messageName').style.color = 'green';\r\n");
      out.write("                 document.getElementById('messageName').innerHTML = 'NO TEST IN THIS PACKAGE YET';\r\n");
      out.write("                 }\r\n");
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("            \r\n");
      ...
      out.write("                var _type = $(this).val();\r\n");
      out.write("                var packageName = sessionStorage.getItem(\"packageName\");\r\n");
      out.write("                document.getElementById(\"packageName\").innerHTML = packageName;\r\n");
      out.write("                $(\"#buttonAdd\").show();\r\n");
      out.write("                $(\"button[id='buttonX']\").removeAttr('disabled');\r\n");
      ...
      out.write("                console.log(valueArray);\r\n");
      out.write("                $.ajax({\r\n");
      out.write("                    type: \"GET\",\r\n");
      ...
      out.write("                                        }\r\n");
      out.write("                                        else {\r\n");
      out.write("                                            if (e.type === 'Child-Male') {\r\n");
      out.write("                                                dataShow.maleIndex = e.indexValueMin + '-' + e.indexValueMax;\r\n");
      out.write("                                            }else if (e.type === 'Child-Female') {\r\n");
      out.write("                                                dataShow.femaleindex = e.indexValueMin + '-' + e.indexValueMax;\r\n");
      out.write("                                            }\r\n");
      out.write("                                        }\r\n");
      out.write("                                    });\r\n");
      ...
      out.write("                for (var i = 0; i < data.length; i++) {\r\n");
      out.write("                    if (data[i].name === txtValue) {\r\n");
      out.write("                        $.ajax({\r\n");
      ...
      out.write("                                 },\r\n");
      out.write("                            url: \"http://14.161.47.36:8080/PHR_System-0.0.1-SNAPSHOT/package-tests/package-test/\" + dataPackage.id + \"/\" + data[i].id,\r\n");
      ...
      out.write("                localStorage.setItem(\"testName\", \"\");\r\n");
      out.write("                var token = sessionStorage.getItem(\"key\");\r\n");
      out.write("                dataPackage = JSON.parse(localStorage.getItem(\"dataPackage\"));\r\n");
      out.write("                var valueArray = [];\r\n");
      out.write("                var arrayTotal = [];\r\n");
      out.write("                var testName = [];\r\n");
      out.write("                console.log(valueArray);\r\n");
